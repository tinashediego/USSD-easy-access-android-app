...
public class MyMobileSms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_mobile_sms);
        telephonyManager = ((TelephonyManager) MyMobileSms.this.getSystemService(Context.TELEPHONY_SERVICE));
    ...
    public void sendMoney(View view){
        if((simOperatorName).equalsIgnoreCase("Econet")) {
            String ussdCode = "*" + "151" +"*"+"4"+"*"+"2"+"*"+"1"+"*"+reg+ Uri.encode("#");
