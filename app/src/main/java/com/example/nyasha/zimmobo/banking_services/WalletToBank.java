...
public class WalletToBank extends AppCompatActivity {
    ...
    public void completeTransfer(View view){
        ...
        String ussdCode = "*" + "151" + "*" + "8" + "*" +1+ "*" +txtWalletAmount+ Uri.encode("#");
        if (ActivityCompat.checkSelfPermission(WalletToBank.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
